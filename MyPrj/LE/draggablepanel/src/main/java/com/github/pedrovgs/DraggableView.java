...
public class DraggableView extends RelativeLayout {
    ...
    public static interface OnTransferEventToView{
        public void onTransferToView(MotionEvent v);
    }

    private OnTransferEventToView onTransfer;

    public OnTransferEventToView getOnTransfer() {
        return onTransfer;
    }

    public void setOnTransfer(OnTransferEventToView onTransfer) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (!isEnabled() || isDisableDraggableView) {
            if(onTransfer!=null) onTransfer.onTransferToView(ev);
            return false;
        }
